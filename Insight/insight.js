let data = [
  ...
  },
  {
    ...
    subheading:
      " an idea of how and where to improve your operations to ensure a healthy revenue cycle",
    summery:
      "Medical coding quality and accuracy have a massive impact on your organization’s bottom line and revenue cycle. ",
  ...
  },
  {
    ...
    subheading: " ",
    summery:
      "With reports indicating denied claims rates are reaching new highs, many medical organizations are scrambling to get their numbers in check. ",
    author: "Taylor Ross",
    date: "May 4, 2022",
    id: 4,
  },
  {
    ...
    subheading:
      "Fathom is the first medical coding automation company to receive investment from a national physician group",
    summery:
      "SAN FRANCISCO, CA — Fathom, the leader in AI medical coding automation, announced it received a strategic investment from Inflect Health, ",
    author: "Fathom Team",
    date: "April 25, 2022",
    id: 5,
  },
  {
    ...
    subheading: "Medical coding accuracy can create immediate and lasting positive impacts on an organization’s revenue cycle. Here are five ways how.",
    summery:
      "Creating a healthy and stable revenue cycle is critical for medical organizations of all shapes and sizes.",
    author: "Amit Jayakar",
    date: "April 22, 2022",
    id: 6,
  },
  {
    ...
    subheading: " ",
    summery:
      "Let’s face it: Healthcare is, in many ways, still an old-fashioned industry. Many patient charts are still housed on paper and stored in manila folders. ",
    author: "Andrew Lockhart",
    date: "April 29, 2020",
    id: 7,
  },
  {
    ...
    subheading: " ",
    summery:
      "With the advent of artificial intelligence technology and its application in solving some of the most complex challenges of companies and industries around the world,",
    author: "Andrew Lockhart",
    date: "April 22, 2020",
    id: 8,
  },
  {
    ...
    subheading: " ",
    summery:
      "Whenever discussing domestic vs. off-shore medical coding, two questions naturally arise. What does “domestic” really mean?",
    author: "Lisa Fong",
  ...
  },
  {
    ...
    subheading: " ",
    summery:
      "Thanks to advances in machine learning and the emergence of cloud computing, computer algorithms today are using human-like intelligence to perform high-level tasks with incredible accuracy at a massive scale. ",
    author: "Fathom Team",
...
let h4 = document.querySelector("#right>h6");
h4.innerText = data[10].type;
let h1 = document.querySelector("#right>h3");
...
let h3 = document.querySelector("#right>h4");
...
let filter = (x) => {
  ...
  let newsContainer = document.getElementById("news_div");
  newsContainer.style.marginBottom = "200px";
  append(filtered, filtered.length - 1);
};
...
let loadMore = () => {
  ...
  loadBtn.style.display = "none";
  let newsContainer = document.getElementById("news_div");
  newsContainer.style.marginBottom = "280px";
